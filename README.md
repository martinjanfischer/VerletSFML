...
1. In Visual Studio select main menu "File, Open, CMake..."
1. In the file dialog window "Open CMake-project from CMakeLists.txt" navigate to the directory of your local SFML git repository and select the file CMakeLists.txt and finally click the button "Open".
